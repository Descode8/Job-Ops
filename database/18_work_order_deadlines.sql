-- Adds an optional deadline to contractor-created work orders.

drop function if exists public.create_and_offer_work_order(text, text, text, text, text, text, uuid);
