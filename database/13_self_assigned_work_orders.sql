-- Allow the authenticated work-order creator to choose "Me" and receive a
-- direct assignment. Other contractors continue to receive a pending offer.
...
begin
  ...
  if p_recipient_id = v_creator_id then
    ...
    values (v_work_order_id, v_creator_id, p_recipient_id);
  end if;
