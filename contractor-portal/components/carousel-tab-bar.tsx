...
const ADMIN_SHORTCUT_ORDER = ['index', 'explore', 'schedule', 'home-progress', 'work-order', 'completed-home', 'completed', 'metrics', 'admin'];
const appVersion = String(Constants.expoConfig?.extra?.jobOpsRelease ?? Constants.expoConfig?.version ?? 'unknown');
...
const styles = StyleSheet.create({
  ...
  gridVersion: { color: '#B3C2D8', fontSize: 10, fontWeight: '700', textAlign: 'center', marginTop: 20 },
