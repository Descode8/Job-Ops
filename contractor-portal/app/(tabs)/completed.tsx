...
type CompletedOrder = { id: string; work_order_number: string; title: string; priority: string; completed_at: string | null; properties: { customer_name: string | null; address_line_1: string; city: string; state: string } | null };
