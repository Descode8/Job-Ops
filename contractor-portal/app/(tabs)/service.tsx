...
const YELLOW = '#FFF200'; const NAVY = '#003366'; const BLUE = '#1E67B2'; const PAPER = '#FFFFFF'; const MUTED = '#566273';
...
const createStyles = (colors: AppThemeColors) => StyleSheet.create({ safeArea: { flex: 1, backgroundColor: colors.background }, content: { flexGrow: 1, backgroundColor: colors.background, paddingHorizontal: 20, paddingBottom: 32 }, header: { backgroundColor: colors.header, marginHorizontal: -20, paddingHorizontal: 20, paddingTop: 22, paddingBottom: 25, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, kicker: { color: YELLOW, fontSize: 10, fontWeight: '900', letterSpacing: 1.4, marginBottom: 8 }, title: { color: PAPER, fontSize: 28, fontWeight: '800' }, summaryRow: { flexDirection: 'row', backgroundColor: colors.header, marginTop: 20, borderRadius: 7, overflow: 'hidden' }, summary: { flex: 1, alignItems: 'center', paddingVertical: 15, borderRightWidth: 1, borderRightColor: colors.border }, summaryValue: { color: YELLOW, fontSize: 20, fontWeight: '900' }, summaryLabel: { color: PAPER, fontSize: 8, fontWeight: '900', marginTop: 4 }, filters: { flexDirection: 'row', gap: 7, marginTop: 18 }, filterButton: { flex: 1, minHeight: 38, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', borderRadius: 6 }, filterSelected: { backgroundColor: colors.primary, borderColor: colors.primary }, filterText: { color: colors.textMuted, fontSize: 10, fontWeight: '800' }, filterTextSelected: { color: PAPER }, count: { color: colors.textMuted, fontSize: 10, fontWeight: '900', letterSpacing: 1.1, marginTop: 24, marginBottom: 12 }, empty: { alignItems: 'center', paddingVertical: 72 }, emptyTitle: { color: colors.text, fontSize: 15, fontWeight: '800', marginTop: 13 }, emptyText: { color: colors.textMuted, fontSize: 11, marginTop: 6, textAlign: 'center' }, card: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, padding: 17, marginBottom: 12, borderRadius: 7 }, cardTop: { flexDirection: 'row', alignItems: 'center' }, statusRow: { flexDirection: 'row', alignItems: 'center' }, statusDot: { width: 7, height: 7, borderRadius: 4, marginRight: 6 }, status: { color: colors.textMuted, fontSize: 9, fontWeight: '900' }, priority: { fontSize: 9, fontWeight: '900', marginLeft: 12 }, id: { color: colors.primary, fontSize: 10, fontWeight: '800', marginLeft: 'auto' }, customer: { color: colors.primary, fontSize: 18, fontWeight: '800', marginTop: 15 }, description: { color: colors.textMuted, fontSize: 12, lineHeight: 18, marginTop: 7 }, infoRow: { flexDirection: 'row', alignItems: 'center', marginTop: 12 }, infoText: { color: colors.text, fontSize: 11, marginLeft: 7, flex: 1 }, dates: { borderTopWidth: 1, borderTopColor: colors.border, marginTop: 15, paddingTop: 12, flexDirection: 'row', alignItems: 'center', gap: 18 }, dateLabel: { color: colors.textMuted, fontSize: 8, fontWeight: '900' }, dateValue: { color: colors.text, fontSize: 10, fontWeight: '800', marginTop: 3 }, partsBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surfaceMuted, paddingHorizontal: 7, paddingVertical: 5, borderRadius: 4, gap: 4, marginLeft: 'auto' }, partsText: { color: colors.text, fontSize: 7, fontWeight: '900' } });
