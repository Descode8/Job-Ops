  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <ScrollView contentContainerStyle={[styles.content, { flexGrow: 0 }]} showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={isRefreshing} onRefresh={onRefresh} tintColor={colors.primary} colors={[colors.primary]} />}>
        ...
        <View style={styles.filters}><FilterButton label="Active" selected={filter === 'active'} onPress={() => setFilter('active')} /><FilterButton label="Urgent" selected={filter === 'urgent'} onPress={() => setFilter('urgent')} /><FilterButton label="Needs Parts" selected={filter === 'parts'} onPress={() => setFilter('parts')} /></View>
