...
const PAPER = '#FFFFFF'; const YELLOW = '#1D4ED8';
...
const createStyles = (colors: AppThemeColors) => StyleSheet.create({ safe: { flex: 1, backgroundColor: colors.background }, header: { minHeight: 150, backgroundColor: colors.header, padding: 24, justifyContent: 'flex-end' }, toggle: { position: 'absolute', right: 20, top: 18 }, title: { color: PAPER, fontSize: 27, fontWeight: '900', marginTop: 12 }, form: { padding: 22 }, help: { color: colors.textMuted, fontSize: 13, lineHeight: 20, marginBottom: 14 }, input: { minHeight: 50, borderWidth: 0.5, borderColor: colors.border, backgroundColor: colors.input, borderRadius: 6, paddingHorizontal: 13, marginTop: 12, color: colors.text }, rules: { backgroundColor: colors.surfaceMuted, borderRadius: 6, padding: 12, marginTop: 10 }, rule: { flexDirection: 'row', alignItems: 'center', marginVertical: 4 }, ruleText: { color: colors.textMuted, fontSize: 11, marginLeft: 8 }, ruleMet: { color: colors.success, fontWeight: '800' }, matchRow: { flexDirection: 'row', alignItems: 'center', marginTop: 9 }, matchText: { fontSize: 11, fontWeight: '800', marginLeft: 7 }, button: { minHeight: 52, backgroundColor: '#243B5C', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 18, paddingHorizontal: 12, borderRadius: 6 }, buttonPressed: { backgroundColor: '#0E1F35' }, disabled: { opacity: 0.45 }, buttonText: { color: PAPER, fontSize: 12, fontWeight: '900', marginLeft: 8 } });
